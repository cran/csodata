...
A list of all the tables available on PxStat can be downloaded with `cso_get_toc`. You can search through the title field using `cso_search_toc`. (A "Loaded cached toc" or "Loaded cached data" message indicates that the data was retrieved from the cache, instead of being downloaded again.)
